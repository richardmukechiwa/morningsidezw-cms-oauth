// =======================================
// Morningside Admin Worker
// =======================================

// Inline Tailwind output.css (paste full content if needed)
const tailwindCSS = `/*! tailwindcss v4.1.17 | MIT License | https://tailwindcss.com */ 
/* minimal example, add full output.css here */`;
...
export default {
  async fetch(request, env) {
    ...
    // --- Default fallback: GitHub Pages serves homepage ---
